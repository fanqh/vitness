...
/** infrastructure mode **/
//char ssid[32]   = "TP-LINK_OVERTECH";
//char passwd[32] = "overtechoffice@2013";
//char chan[32]   = "0";
//char iphost[32] = "192.168.1.118";
...
void ProcessTimeEvent(void)
{
    ...
    if(WifiState==CONNECT)    ///it should palce the all function after
	{
			P1_0 = 0;				// turn on led1
    		P0_7 = 0;				// turn on led1	
	}
